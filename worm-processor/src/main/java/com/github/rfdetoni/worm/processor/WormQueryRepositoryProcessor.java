...
import com.github.rfdetoni.worm.annotation.query.JlfQuery;
 ...
 */
@SupportedAnnotationTypes("com.github.rfdetoni.worm.annotation.query.QueryRepository")
@SupportedSourceVersion(SourceVersion.RELEASE_25)
public final class WormQueryRepositoryProcessor extends AbstractProcessor {

    private static final String IMPL_PACKAGE = "com.github.rfdetoni.worm.generated.repository";
    private static final String SERVICE_PATH = "META-INF/services/com.github.rfdetoni.worm.repository.query.GeneratedQueryRepositoryProvider";
    ...
    private String writeImplementation(TypeElement repoType) throws IOException {
        ...
        try (Writer writer = implFile.openWriter()) {
            ...
            writer.write("import com.github.rfdetoni.worm.orm.OrmOperations;\n");
            writer.write("import com.github.rfdetoni.worm.query.Pageable;\n");
            writer.write("import com.github.rfdetoni.worm.query.Slice;\n");
        ...
        try (Writer writer = providerFile.openWriter()) {
            writer.write("package " + IMPL_PACKAGE + ";\n\n");
            writer.write("import com.github.rfdetoni.worm.orm.OrmOperations;\n");
            writer.write("import com.github.rfdetoni.worm.repository.query.GeneratedQueryRepositoryProvider;\n\n");
    ...
    private QueryPlan analyzeMethod(ExecutableElement method) {
        ...
        for (int i = 0; i < params.size(); i++) {
            ...
            if ("com.github.rfdetoni.worm.query.Pageable".equals(parameter.asType().toString())) {
                pageableIndex = i;
                continue;
            }
    ...
    private enum QueryReturnKindModel {
        ...
        static QueryReturnKindModel of(ExecutableElement method) {
            ...
            if (raw.startsWith("com.github.rfdetoni.worm.query.Slice<")) return SLICE;
