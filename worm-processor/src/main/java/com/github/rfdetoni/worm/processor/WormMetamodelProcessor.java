 ...
 *       column descriptor usable in the type-safe {@link FilterBuilder}
 *       overloads.</li>
 * </ul>
 *
...
public final class WormMetamodelProcessor extends AbstractProcessor {
    ...
    private static final String WORM_ATTRIBUTE_FQN = "com.github.rfdetoni.worm.orm.registry.WormAttribute";
    ...
    public synchronized void init(ProcessingEnvironment processingEnv) {
        ...
        this.dslAvailable = elements.getTypeElement("com.github.rfdetoni.worm.dsl.EntityPath") != null;
    }
    ...
    private void writeMetamodelClass(TypeElement entityType) throws IOException {
        ...
        try (Writer w = file.openWriter()) {
            ...
            w.write(" */\n");
            w.write("@javax.annotation.processing.Generated(\"com.github.rfdetoni.worm.processor.WormMetamodelProcessor\")\n");
    ...
    private void writeQueryPathClass(TypeElement entityType) throws IOException {
        ...
        try (Writer w = file.openWriter()) {
            ...
            w.write("import com.github.rfdetoni.worm.dsl.*;\n");
            w.write("import com.github.rfdetoni.worm.util.AliasUtils;\n\n");
            w.write("/**\n");
