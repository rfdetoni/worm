...
public class WormQueryRepoTest {
    ...
    static class Cfg {
        ...
        public OrmOperations ormOperations() {
            ...
            return new OrmOperations() {
                ...
                @Override
                public <T> java.util.Optional<T> findOne(Class<T> clazz, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T, P> java.util.Optional<P> findOne(Class<T> entityClass, br.com.liviacare.worm.query.FilterBuilder filter, Class<P> projectionClass) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T> java.util.List<T> findAll(Class<T> clazz, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.List.of();
                }

                @Override
                public <T> br.com.liviacare.worm.query.Slice<T> findAll(Class<T> clazz, br.com.liviacare.worm.query.FilterBuilder filter, br.com.liviacare.worm.query.Pageable pageable) {
                    return null;
                }

                @Override
                public <T, P> java.util.List<P> findAll(Class<T> entityClass, br.com.liviacare.worm.query.FilterBuilder filter, Class<P> projectionClass) {
                    return java.util.List.of();
                }

                @Override
                public <T> br.com.liviacare.worm.query.Page<T> findPage(Class<T> clazz, br.com.liviacare.worm.query.FilterBuilder filter, br.com.liviacare.worm.query.Pageable pageable) {
                    return null;
                }

                @Override
                public <T> java.util.List<T> findAllWithCte(Class<T> entityClass, br.com.liviacare.worm.query.FilterBuilder filterWithCte) {
                    return java.util.List.of();
                }

                @Override
                public <T, P> java.util.List<P> findAllWithCte(Class<T> entityClass, br.com.liviacare.worm.query.FilterBuilder filterWithCte, Class<P> projectionClass) {
                    return java.util.List.of();
                }

                @Override
                public <T> boolean exists(Class<T> clazz, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return false;
                }
                ...
                @Override
                public <T> long count(Class<T> clazz, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return 0;
                }

                @Override
                public <T, N extends Number> java.util.Optional<N> sum(Class<T> clazz, String column, Class<N> type, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T, N extends Number> java.util.Optional<N> min(Class<T> clazz, String column, Class<N> type, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T, N extends Number> java.util.Optional<N> max(Class<T> clazz, String column, Class<N> type, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T> java.util.Optional<Double> avg(Class<T> clazz, String column, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T, C> java.util.List<C> findColumn(Class<T> clazz, String columnName, Class<C> type, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.List.of();
                }

                @Override
                public <T, C> java.util.Optional<C> findColumnOne(Class<T> clazz, String columnName, Class<C> type, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T, R> java.util.List<R> queryList(Class<T> entityClass, String baseSql, Class<R> type, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.List.of();
                }

                @Override
                public <T, R> java.util.Optional<R> queryOne(Class<T> entityClass, String baseSql, Class<R> type, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T> java.util.Optional<String> jsonPathQueryFirst(Class<T> clazz, String column, String jsonPath, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T> java.util.Optional<String> jsonPathQueryFirstWithVars(Class<T> clazz, String column, String jsonPath, Object varsJson, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }

                @Override
                public <T> java.util.Optional<String> jsonPathQueryArray(Class<T> clazz, String column, String jsonPath, br.com.liviacare.worm.query.FilterBuilder filter) {
                    return java.util.Optional.empty();
                }
    ...
    public static class ContextInitializer implements org.springframework.context.ApplicationContextInitializer<org.springframework.context.ConfigurableApplicationContext> {
        ...
        public void initialize(org.springframework.context.ConfigurableApplicationContext applicationContext) {
            ...
            def.setTargetType(br.com.liviacare.worm.orm.OrmOperations.class);
            def.setInstanceSupplier(() -> new br.com.liviacare.worm.orm.OrmOperations() {
                @Override
                public <T> void save(T entity) {
                }
            ...
            try {
                br.com.liviacare.worm.config.query.QueryRepositoriesAutoConfiguration.QueryRepositoriesRegistrar registrar =
                        new br.com.liviacare.worm.config.query.QueryRepositoriesAutoConfiguration.QueryRepositoriesRegistrar();
    ...
    public static org.springframework.beans.factory.support.BeanDefinitionRegistryPostProcessor invokeQueryRegistrar(org.springframework.core.env.Environment environment) {
        return new org.springframework.beans.factory.support.BeanDefinitionRegistryPostProcessor() {
            ...
            public void postProcessBeanDefinitionRegistry(org.springframework.beans.factory.support.BeanDefinitionRegistry registry) throws org.springframework.beans.BeansException {
                br.com.liviacare.worm.config.query.QueryRepositoriesAutoConfiguration.QueryRepositoriesRegistrar registrar = new br.com.liviacare.worm.config.query.QueryRepositoriesAutoConfiguration.QueryRepositoriesRegistrar();
