...
public final class QueryRepositoryFactory {
    ...
    public static <T> T create(Class<T> repositoryInterface, OrmOperations ormOperations) {
        ...
        T generated = GeneratedQueryRepositoryLookup.create(repositoryInterface, ormOperations);
        if (generated != null) {
            return generated;
        }
        return createProxyFallback(repositoryInterface, ormOperations);
    }

    public static <T> T createProxyFallback(Class<T> repositoryInterface, OrmOperations ormOperations) {
