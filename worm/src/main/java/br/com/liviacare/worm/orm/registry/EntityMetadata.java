...
public final class EntityMetadata<T> {
     ...
     * {@link br.com.liviacare.worm.annotation.mapping.DbJoin.FetchMode#BATCH}.
    ...
    public boolean hasBatchFetchJoins() {
        if (joinInfos == null) return false;
        for (JoinInfo ji : joinInfos) {
            if (ji != null && ji.isList() && ji.getFetchMode() == br.com.liviacare.worm.annotation.mapping.DbJoin.FetchMode.BATCH) return true;
        }
        return false;
    }
